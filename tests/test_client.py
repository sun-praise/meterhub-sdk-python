...
def _get_open_connections(client: Meterhub | AsyncMeterhub) -> int:
...
class TestMeterhub:
    client = Meterhub(base_url=base_url, api_key=api_key, _strict_response_validation=True)
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "meterhub/_legacy_response.py",
                        "meterhub/_response.py",
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(MeterhubError):
            with update_env(**{"METERHUB_API_KEY": Omit()}):
                client2 = Meterhub(base_url=base_url, api_key=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, client: Meterhub) -> None:
        request = client._build_request(
    ...
    def test_base_url_setter(self) -> None:
        client = Meterhub(base_url="https://example.com/from_init", api_key=api_key, _strict_response_validation=True)
    ...
    def test_base_url_env(self) -> None:
        with update_env(METERHUB_BASE_URL="http://localhost:5000/from/env"):
            client = Meterhub(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"

    @pytest.mark.parametrize(
        "client",
        [
            Meterhub(base_url="http://localhost:5000/custom/path/", api_key=api_key, _strict_response_validation=True),
            Meterhub(
    ...
    def test_base_url_trailing_slash(self, client: Meterhub) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Meterhub) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Meterhub) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_client_max_retries_validation(self) -> None:
        with pytest.raises(TypeError, match=r"max_retries cannot be None"):
            Meterhub(base_url=base_url, api_key=api_key, _strict_response_validation=True, max_retries=cast(Any, None))
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = Meterhub(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = Meterhub(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    def test_retries_taken(
        ...
        respx_mock.post("/api/v1/meter/detect/").mock(side_effect=retry_handler)

        response = client.api.v1.meter.with_raw_response.detect(image="image")
    ...
    def test_omit_retry_count_header(
        self, client: Meterhub, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
        ...
        response = client.api.v1.meter.with_raw_response.detect(
            image="image", extra_headers={"x-stainless-retry-count": Omit()}
        )
    ...
    def test_overwrite_retry_count_header(
        ...
        response = client.api.v1.meter.with_raw_response.detect(
            image="image", extra_headers={"x-stainless-retry-count": "42"}
        )

        assert response.http_request.headers.get("x-stainless-retry-count") == "42"


class TestAsyncMeterhub:
    client = AsyncMeterhub(base_url=base_url, api_key=api_key, _strict_response_validation=True)
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(MeterhubError):
            with update_env(**{"METERHUB_API_KEY": Omit()}):
                client2 = AsyncMeterhub(base_url=base_url, api_key=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, async_client: AsyncMeterhub) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(METERHUB_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncMeterhub(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncMeterhub) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncMeterhub) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncMeterhub) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncMeterhub(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncMeterhub(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    async def test_retries_taken(
        ...
        response = await client.api.v1.meter.with_raw_response.detect(image="image")
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncMeterhub, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
        ...
        response = await client.api.v1.meter.with_raw_response.detect(
            image="image", extra_headers={"x-stainless-retry-count": Omit()}
        )
    ...
    def test_get_platform(self) -> None:
        ...
        from meterhub._utils import asyncify
        from meterhub._base_client import get_platform
